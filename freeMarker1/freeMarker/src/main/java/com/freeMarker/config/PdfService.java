...
public class PdfService {
    ...
    public void generatePdfFileFromTemplate(String templateName, Path pdfFile)
        ...
        try (InputStream embArial = PdfService.class.getResourceAsStream("/static/fonts/Arial.ttf");
                ...
                InputStream embArialItalicBold = PdfService.class.getResourceAsStream("/static/fonts/ArialItalicBold.ttf");
                ...
                InputStream embCenturyGothicItalicBold = PdfService.class.getResourceAsStream("/static/fonts/GOTHICBI.ttf");
    ...
    private Map<String, Object> prepareTemplateData() {
        ...
        ctxVarsMap.put("messageB20",
                "SILA LAYARI WWW.BANKISLAM.COM.MY UNTUK MENDAPATKAN INFO TERK INI BERKENAAN TERMA DAN SYARAT KAD KREDIT-I BANK ISLAM.");
        ...
        tx2.put("description", "Alternate Media                     &gt; &lt; MERCHANT CITYMYS &amp; &amp; &amp;VALUES CASHBACK VALUES");
        ...
        // row1.put("description", "FN PAYMENT THRU CDM FN PAYMENT THRU CDM FN PAYMENT THRU CDM");
        ...
        // ctxVarsMap.put("totalMessages", "To find out more.please visit our branch or
        ...
        // headerMap.put("amortized", "5555");
        // headerMap.put("residualValue", "5555");
        // headerMap.put("message", "Pay off your outstanding credit card bills faster
        ...
        // Consumer |Deposit &amp; Payment Services with effect from 1 April 2009.|Bank
