...
//import com.example.processor.CustomProcessor;
//import com.example.repository.TransactionDtoRepository;
//
...
//				.<TransactionDetails, TransactionDto>chunk(10, transactionManager)
//				.reader(reader())
//                .processor(processor())
//				.writer(writer())
//				.build();
...
//          .resource(new ClassPathResource("STMT4_SAMPLE.txt"))
//          .strict(false)
//          .fixedLength()
...
//		return new RepositoryItemWriterBuilder<TransactionDto>()
//				.methodName("save")
